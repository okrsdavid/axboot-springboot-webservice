package edu.axboot.domain.init;
...
import edu.axboot.domain.program.ProgramService;
import edu.axboot.domain.program.menu.Menu;
import edu.axboot.domain.program.menu.MenuService;
import edu.axboot.domain.user.User;
import edu.axboot.domain.user.UserService;
import edu.axboot.domain.user.auth.UserAuth;
import edu.axboot.domain.user.auth.UserAuthService;
import edu.axboot.domain.user.auth.menu.AuthGroupMenu;
import edu.axboot.domain.user.auth.menu.AuthGroupMenuService;
import edu.axboot.domain.user.role.UserRole;
import edu.axboot.domain.user.role.UserRoleService;
